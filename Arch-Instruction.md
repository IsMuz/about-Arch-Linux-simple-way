...
1) Если хотите в дальнейшем его установить, то нужно создать раздел в FAT-32 размером 300-1000 Мб:
...
Монтируем раздел в /boot/efi.

2) Будете пользоваться только Linux, тогда нужно создать раздел в ext4 и смонтировать туда /boot.
