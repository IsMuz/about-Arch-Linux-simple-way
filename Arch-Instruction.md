...
1. [Установка Arch Linux](#установка-arch-linux)
   ...
   1. [Размечаем диск](#размечаем-диск)
   ...
   1. [Завершение установки](#завершение-установки)
...
1. [i3](#i3)
   1. [Описание](#описание)
   1. [Установка и настройка i3](#установка-и-настройка-i3)
   1. [XTerm](#xterm)
