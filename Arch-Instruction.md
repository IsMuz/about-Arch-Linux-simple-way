...
Если на диске не установлен Windows, то нужно выделить 300-1000 Мб под Efi раздел, и создадим на нем файловую систему FAT-32:
